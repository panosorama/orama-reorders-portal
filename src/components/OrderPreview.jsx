...
export default function OrderPreview({ mockupUrl, productType, specifications, quantity, pricing, shippingCharge, shippingMethod, shipToAddress, onApprove, isProcessing }) {
